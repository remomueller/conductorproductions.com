...
class VideosControllerTest < ActionController::TestCase
  ...
  test "should create video as system admin" do
    ...
    assert_difference('Video.count') do
      post :create, video: { page: @video.page, vimeo_number: '124955435', photo: fixture_file_upload('../../test/support/projects/rails.png'), position: @video.position, archived: @video.archived }
    end
  ...
  test "should update video as system admin" do
    login(@system_admin)
    patch :update, id: @video, video: { page: @video.page, vimeo_number: @video.vimeo_number, photo: fixture_file_upload('../../test/support/projects/rails.png'), archived: @video.archived }
    assert_redirected_to video_path(assigns(:video))
  end
