...
class LocationPhotosControllerTest < ActionController::TestCase
  ...
  #     post :create, params: { location_photo: { location_id: @location_photo.location_id, photo: @location_photo.photo, project_id: @location_photo.project_id, user_id: @location_photo.user_id } }
  #   end
  ...
  test 'should download location photo as owner' do
    login(@system_admin)
    get :download, params: { project_id: @project, location_id: @location, id: @location_photo }
  ...
  test 'should show location photo as owner' do
    login(@system_admin)
    get :show, params: { project_id: @project, location_id: @location, id: @location_photo }
    assert_response :success
  end
  ...
  #   get :edit, params: { id: @location_photo }
  #   assert_response :success
  # end

  # test 'should update location_photo' do
  #   patch :update, params: { id: @location_photo, location_photo: { location_id: @location_photo.location_id, photo: @location_photo.photo, project_id: @location_photo.project_id, user_id: @location_photo.user_id } }
  #   assert_redirected_to location_photo_path(assigns(:location_photo))
  # end
  ...
  test 'should destroy location photo as owner' do
    ...
    assert_difference('LocationPhoto.count', -1) do
      delete :destroy, params: { project_id: @project, location_id: @location, id: location_photos(:three) }
    end
